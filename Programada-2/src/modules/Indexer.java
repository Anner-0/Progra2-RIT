...
public class Indexer {
    ...
    public void documentCreator(String labelName,String data) {// this method set documents that will be stored on the index
        ...
        System.out.println("Document Created: " +labelName);
    }
    ...
    public void createIndex(int indexNumber) throws Exception {
        IndexWriter writer = selectIndexWriter(indexNumber);
        writer.deleteAll();
